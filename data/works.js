window.worksData = [
    {
        ...
        items: [
            ...
            },
            {
                index: "02",
                title: "FMP7.nvim",
                description: "A Neovim plugin to control FMP7 (FM Music Drv.).",
                url: "https://github.com/T-b-t-nchos/FMP7.nvim",
                ariaLabel: "View FMP7.nvim"
            },
            {
                index: "03",
                title: "️nothing.nvim",
            ...
            },
            {
                index: "04",
                title: "sshhub",
                description: "A CLI tool to easily multiple SSH connections.",
                url: "https://github.com/T-b-t-nchos/sshhub",
                ariaLabel: "View sshhub"
            },
            {
                index: "05",
                title: "mm2f",
                description: "[M]ultiple package [M]anager packages [To] a [F]ile.",
                url: "https://github.com/T-b-t-nchos/mm2f",
                ariaLabel: "View mm2f"
            }
        ]
    },
    {
        ...
        items: [
            {
                index: "2025",
                title: "湘南藤沢高専 Discordキャンパス「第1回LTイベント　PR動画」",
                description: "A promo video for a LT event at the Shonan Fujisawa Kosen Discord campus (sf-kosen, a fictional college)",
